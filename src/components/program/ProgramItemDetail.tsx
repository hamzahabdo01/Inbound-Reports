  ...
  return (
    <div className="space-y-5">
      ...
      <section id="pd-charts">
        ...
        <DetailChartPanel title="Funding Source" action={<div className="flex items-center gap-1"><IconButton variant="expand" data={FUNDING_SOURCE_DATA} title="Funding Source" /><TinySelect /></div>}>
        ...
        <DetailChartPanel title="Procurement Agents" action={<div className="flex items-center gap-1"><IconButton variant="expand" data={[{ label: 'EPSS', value: 65, color: '#0B4F54' }, { label: 'WHO', value: 35, color: '#86BFC5' }]} title="Procurement Agents" /><TinySelect /></div>}>
        ...
        <DetailChartPanel title="Distribution by Facility Type" action={<div className="flex items-center gap-1"><IconButton variant="expand" data={hubStockRows.slice(0, 4)} title="Distribution by Facility Type" /><TinySelect /></div>}>
        ...
        <DetailChartPanel title="Distribution by Ownership Type" action={<div className="flex items-center gap-1"><IconButton variant="expand" data={[{ label: 'Public', value: 68, color: '#0B4F54' }, { label: 'Private', value: 22, color: '#86BFC5' }, { label: 'Others', value: 10, color: '#D97706' }]} title="Distribution by Ownership Type" /><TinySelect /></div>}>
          <div className="flex items-center justify-center py-4">
            <div className="w-[380px]">
              <PieChart
                data={[
        ...
        <DetailChartPanel title="Distribution by Region" action={<div className="flex items-center gap-1"><IconButton variant="expand" data={hubStockRows.slice(0, 8)} title="Distribution by Region" /><TinySelect /></div>}>
