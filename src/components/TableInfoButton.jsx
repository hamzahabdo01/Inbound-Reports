...
export default function TableInfoButton({ tableId, className = '' }) {
  ...
  return (
    <>
      <button
        ...
        title="Table Information & Guide"
        aria-label="Open Table Guide"
      >
        {/* Inner Light Circle Wrapper */}
          {/* Core Dark Teal Circle with Stylized Serif 'i' */}
