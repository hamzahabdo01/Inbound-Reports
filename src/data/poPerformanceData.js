...
function generateLeadtime(pos) {
  const details = pos.slice(0, 50).map((po) => {
    ...
    return {
      ...
      contractToPO: Math.round((poDate - contractDate) / (1000 * 60 * 60 * 24)),
      poToLCOpening: Math.round((lcDate - poDate) / (1000 * 60 * 60 * 24)),
      lcToPortArrival: Math.round((portDate - lcDate) / (1000 * 60 * 60 * 24)),
      portToCleared: Math.round((clearedDate - portDate) / (1000 * 60 * 60 * 24)),
      clearedToReceive: Math.round((receiveDate - clearedDate) / (1000 * 60 * 60 * 24)),
      totalLeadtime: Math.round((receiveDate - contractDate) / (1000 * 60 * 60 * 24)),
    };
  });
  const summary = {
